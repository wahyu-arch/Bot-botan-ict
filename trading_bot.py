...
class ICTTradingBot:
    ...
    def __init__(self):
        ...
        self.model_main   = os.getenv("GROQ_MODEL_MAIN",   "groq/compound")
        self.model_ai1    = os.getenv("GROQ_MODEL_AI1",    "groq/compound")
        self.model_ai2    = os.getenv("GROQ_MODEL_AI2",    "groq/compound")
        ...
        # Fase: h1_scan → fvg_h1_wait → idm_hunt → bos_guard → entry_sniper
...
""",
    ...
    def _run_specialist_cycle(self, market_context: dict, triggered_item: dict = None) -> dict | None:
        ...
        # ── FASE 1: H1 SCAN (AI-1) — Deteksi BOS + FVG H1 ──
        # Tidak ada IDM H1. Setelah BOS → tunggu FVG H1 disentuh wick → ke IDM M5.
        if phase == "h1_scan":
